...
import { updateApplication } from '@/lib/api/internships'
import { useEffect, useState } from 'react';
import { useRouter } from 'next/navigation';
import { getApplications, addApplication, deleteApplication } from '@/lib/api/internships';
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    getApplications()
      .then((data) => { setApplications(data); setIsLoaded(true); })
