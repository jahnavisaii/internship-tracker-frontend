      ...
      <div className="flex flex-1 flex-col justify-center px-8 py-12 bg-white">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="flex gap-3 mb-4">
            <div className="flex-1">
              ...
              <input
                ...
                placeholder="Jane"
                className="w-full h-9 px-3 rounded-lg border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
            </div>
            <div className="flex-1">
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-10 bg-blue-700 hover:bg-blue-800 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-60"
          >
